...
public class Potencia extends Expresion {
    ...
    public Potencia(int linea, int columna, Expresion var1, Expresion var2) {
        this.LINEA = linea;
    ...
    private Expresion operar(Expresion resul1, Expresion resul2) {
        ...
        switch (TratamientoTipos.tipoSuperiorExpresion(resul1, resul2)) {
            ...
            case ENTERO:
                ...
                resul.VALOR.clear();
                resul.VALOR.add(Math.pow(Double.parseDouble(resul1.VALOR.get(0).toString()), Double.parseDouble(resul2.VALOR.get(0).toString())));
                break;
            case NUMERIC:
                resul.TIPO = new Tipo(Tipo.EnumTipo.NUMERIC);
                resul.VALOR.clear();
