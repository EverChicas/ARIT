...
public class Suma extends Expresion {
    ...
    public Expresion getValor(Entorno e) {
        ...
        if (resul1.TIPO.Tipo == Tipo.EnumTipo.C && resul2.TIPO.Tipo == Tipo.EnumTipo.C) {
            ...
            if (ValidarTiposVectores.validarVectorAritmeticoS(this.LINEA, this.COLUMNA, (Expresion) resul1.VALOR.get(2), (Expresion) resul2.VALOR.get(2))) {
                return operacion2Matrices(e, resul1, resul2);
            }
        } else if (resul1.TIPO.Tipo == Tipo.EnumTipo.MATRIZ) {
            if (ValidarTiposVectores.validarVectorAritmeticoS(this.LINEA, this.COLUMNA, (Expresion) resul1.VALOR.get(2), resul2)) {
                return operarMatrixIzquierda(e, resul1, resul2);
            }
        } else if (resul2.TIPO.Tipo == Tipo.EnumTipo.MATRIZ) {
            if (ValidarTiposVectores.validarVectorAritmeticoS(this.LINEA, this.COLUMNA, resul1, (Expresion) resul2.VALOR.get(2))) {
