...
public class DiferenteQue extends Expresion {
    ...
    private Expresion operar(Expresion resul1, Expresion resul2) {
        ...
        if (resul1.TIPO.Tipo == Tipo.EnumTipo.STRING || resul2.TIPO.Tipo == Tipo.EnumTipo.STRING) {
            ...
            resul.VALOR.clear();
            resul.VALOR.add(SonDiferentes(resul1.VALOR.get(0).toString().toLowerCase(), resul2.VALOR.get(0).toString().toLowerCase()));
            ...
            resul.VALOR.add(SonDiferentes(String.valueOf(tmp1), String.valueOf(tmp2)));
