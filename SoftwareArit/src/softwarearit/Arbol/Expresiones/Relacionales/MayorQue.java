...
public class MayorQue extends Expresion{
    ...
    public MayorQue(int linea,int columna,Expresion var1,Expresion var2){
        this.LINEA = linea;
    ...
    public Expresion getValor(Entorno e) {
        ...
        if(resul1.TIPO.Tipo == Tipo.EnumTipo.STRING && resul2.TIPO.Tipo == Tipo.EnumTipo.STRING){
            ...
            Interfaz.addError(new NodoError(new TipoError(TipoError.EnumTipoError.SEMANTICO), "Error de tipos para mayor que " + resul1.TIPO.Tipo + ", " + resul2.TIPO.Tipo, LINEA, COLUMNA));
        }
        return resul;
    }
}
