 ...
 * @author chicas
 */
public class Trunk extends AbstractFuncion {

    LinkedList<Nodo> lista;

    public Trunk(int linea, int columna, LinkedList<Nodo> lista) {
        this.LINEA = linea;
    ...
    private void generarGrafica() {
        ...
        this.GRAFICA = Interfaz.GRAFICA_ARBOL.generarGraficaPadreHijosNodos("TRUNK", this, this.lista);
    }
    ...
    public Expresion getValor(Entorno e) {
        ...
        if (this.lista.get(0) instanceof Expresion) {
            ...
            if (resulValor.TIPO.Tipo == Tipo.EnumTipo.ERROR) {
                ...
                String valorEntero = String.valueOf((int) Double.parseDouble(resulValor.VALOR.get(0).toString()));
            ...
            if (resulInstruccion instanceof Expresion) {
                if (((Expresion) resulInstruccion).TIPO.Tipo == Tipo.EnumTipo.ERROR) {
                    ...
                    resul.TIPO.Tipo = Tipo.EnumTipo.ENTERO;
                    String valorEntero = String.valueOf((int) Double.parseDouble(((Expresion) resulInstruccion).VALOR.get(0).toString()));
                    resul.VALOR.add(Integer.parseInt(valorEntero));
