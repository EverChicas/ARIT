 ...
 * @author chicas
 */
public class TypeOf extends AbstractFuncion {

    LinkedList<Nodo> lista;

    TypeOf(int linea, int columna, LinkedList<Nodo> parametros) {
        this.LINEA = linea;
    ...
    private void generarGrafica() {
        ...
        this.GRAFICA = Interfaz.GRAFICA_ARBOL.generarGraficaPadreHijosNodos("TYPEOF", this, this.lista);
    }
    ...
    public Expresion getValor(Entorno e) {
        ...
        if (this.lista.get(0) instanceof Expresion) {
            ...
            if (resulValor.TIPO.Tipo == Tipo.EnumTipo.ERROR) {
                ...
                resul.VALOR.add(resulValor.TIPO.Tipo);
            }
            ...
            if (resulInstruccion instanceof Expresion) {
                if (((Expresion) resulInstruccion).TIPO.Tipo == Tipo.EnumTipo.ERROR) {
                    ...
                    resul.VALOR.clear();
                    resul.TIPO.Tipo = Tipo.EnumTipo.STRING;
                    resul.VALOR.add(((Expresion) resulInstruccion).TIPO.Tipo);
                }
            } else {
