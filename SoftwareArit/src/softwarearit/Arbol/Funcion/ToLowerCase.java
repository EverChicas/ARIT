 ...
 * @author chicas
 */
public class ToLowerCase extends AbstractFuncion {

    LinkedList<Nodo> lista;

    public ToLowerCase(int linea, int columna, LinkedList<Nodo> lista) {
        this.LINEA = linea;
    ...
    private void generarGrafica() {
        ...
        this.GRAFICA = Interfaz.GRAFICA_ARBOL.generarGraficaPadreHijosNodos("TOLOWERCASE", this, this.lista);
    }
    ...
    public Expresion getValor(Entorno e) {
        ...
        if (this.lista.get(0) instanceof Expresion) {
            ...
            if (resulValor.TIPO.Tipo == Tipo.EnumTipo.ERROR) {
                ...
                resul.VALOR.add(((String) resulValor.VALOR.get(0)).toString().toLowerCase());
            ...
            if (resulInstruccion instanceof Expresion) {
                if (((Expresion) resulInstruccion).TIPO.Tipo == Tipo.EnumTipo.ERROR) {
                    ...
                    resul.VALOR.clear();
                    resul.TIPO.Tipo = Tipo.EnumTipo.STRING;
                    resul.VALOR.add(((String) ((Expresion) resulInstruccion).VALOR.get(0)).toString().toLowerCase());
