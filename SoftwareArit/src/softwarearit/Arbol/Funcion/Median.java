 ...
 * @author chicas
 */
public class Median extends AbstractFuncion {

    LinkedList<Nodo> lista;

    public Median(int linea, int columna, LinkedList<Nodo> lista) {
        this.LINEA = linea;
    ...
    private void generarGrafica() {
        ...
        this.GRAFICA = Interfaz.GRAFICA_ARBOL.generarGraficaPadreHijosNodos("MEDIAN", this, this.lista);
    }
    ...
    public Expresion getValor(Entorno e) {
        ...
        resul.VALOR.clear();
        resul.VALOR.add(medianOperacion(valoresOperar));
        return resul;
    }
    ...
    private double medianOperacion(ArrayList<Double> lista) {
        int n = lista.size();
        double mediana = 0;
        lista = burbuja(lista);
        if (lista.size() % 2 == 0) {
             double sumaMedios = lista.get(n / 2) + lista.get((n / 2) - 1);
