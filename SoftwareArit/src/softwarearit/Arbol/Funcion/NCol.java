 ...
 * @author chicas
 */
public class NCol extends AbstractFuncion {
    
    LinkedList<Nodo> matrix;
    
    public NCol(int linea, int columna, LinkedList<Nodo> parametros) {
        this.LINEA = linea;
    ...
    private void generarGrafica() {
        ...
        this.GRAFICA = Interfaz.GRAFICA_ARBOL.generarGraficaPadreHijosNodos("NCOL", this, this.matrix);
    }
